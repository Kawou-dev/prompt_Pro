import { FaArrowLeft, FaArrowRight, FaRegClock, FaChartLine, FaRegStar, FaCog, FaBell, FaUser, FaSearch, FaFilter, FaCopy, FaHeart, FaRegHeart, FaInstagram, FaLinkedin, FaTwitter, FaBars } from "react-icons/fa"
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="flex pt-16">
        ...
        <section className="flex-1 min-h-screen p-4 sm:p-6 lg:pr-80"> {/* Marge pour la sidebar */}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between pt-6 mt-6 border-t border-gray-200 gap-4">
        ...
        <section className="hidden lg:block w-80 bg-white border-l border-gray-200 fixed right-0 top-16 h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="p-6">
            {/* Filtres Rapides */}
            <div className="mb-8">
